...
- Slash commands for YMD/PMD authoring
- Specialized agents for composition and validation
- Complete GitHub PR example (from ymd-prompt)
- Simple examples (basic YMD, custom sections, leaf/composite PMDs)
- Jekyll documentation site structure
- Installation script
- MIT License
